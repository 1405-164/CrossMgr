...
def CallupResultsToExcel( fname_excel, registration_headers, callup_headers, callup_results, is_callup=True, top_riders=999999, exclude_unranked=False, write_uci_id_no_spaces=False ):
		...
		for c, value in enumerate(row):
			...
			if isinstance(v, datetime.date):
				...
				if c == last_name_col:
					...
					v = Model.format_uci_id( '{}'.format(v), write_uci_id_no_spaces )
